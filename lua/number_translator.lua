...
-- 數字、金額大寫
-- 觸發前綴默認為 recognizer/patterns/number 的第 2 個字符，即 R
...
-- 數值轉換為中文
local function number2cnChar(num, flag, digitUnit, wordFigure) --flag=0中文小寫反之為大寫
    local result = ""
...
local function number_translatorFunc(num)
    ...
    table.insert(result,
        ...
        decimal_func(numberPart.dec, { [1] = "角", [2] = "分", [3] = "釐", [4] = "毫" },
            { [0] = "零", "壹", "貳", "參", "肆", "伍", "陸", "柒", "捌", "玖" }), "〔金額大寫〕" })
    return result
end

local function number_translator(input, seg, env)
    -- 獲取 recognizer/patterns/number 的第 2 個字符作為觸發前綴
