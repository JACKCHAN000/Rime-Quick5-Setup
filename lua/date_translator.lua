...
-- 提高權重的原因：因為在方案中設置了大於 1 的 initial_quality，導致 rq sj xq dt ts 產出的候選項在所有詞語的最後。
...
function M.func(input, seg, env)
    ...
    -- ISO 8601/RFC 3339 的時間格式 （固定東八區）（示例 2022-01-07T20:42:51+08:00）
